%{
flevbl.SubTrialRelStimSwapTimes (computed) # my newest table
-> flevbl.SubTrials
...
classdef SubTrialRelStimSwapTimes < dj.Relvar & dj.AutoPopulate
    ...
    properties(Constant)
        table = dj.Table('flevbl.SubTrialRelStimSwapTimes')
        popRel = flevbl.SubTrials  % !!! update the populate relation
    end
