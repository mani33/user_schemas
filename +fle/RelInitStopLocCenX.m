%{
fle.RelInitStopLocCenX (computed) # my newest table
-> fle.TrialGroup
-> vstim.PixPerDeg
...
classdef RelInitStopLocCenX < dj.Relvar & dj.AutoPopulate
    ...
    properties(Constant)
        table = dj.Table('fle.RelInitStopLocCenX')
        popRel = fle.TrialGroup & fle.StimConstants('flash_init=1 and flash_stop =1') ...
