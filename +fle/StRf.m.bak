%{
flevbl.StRf (computed) # my newest table
...
classdef StRf < dj.Relvar & dj.AutoPopulate
	...
	properties(Constant)
		table = dj.Table('flevbl.StRf')
		popRel = flevbl.BarGrayLevels*flevbl.SpikeSets*flevbl.StRfParams  % !!! update the populate relation
	end
