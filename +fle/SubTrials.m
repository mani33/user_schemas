% fle.SubTrials - SubTrial level information for FlePhysEffExperiment
%

%{
fle.SubTrials (computed) # my newest table
-> fle.TrialGroup
...
classdef SubTrials < dj.Relvar
    ...
    methods
        ...
        function makeTuples(self, key)
            ...
            nVtrials = numel(vInd);
            exp_type = fetch1(acq.Stimulation(key),'exp_type');
%             if strcmp(exp_type,'FlePhysExperiment')
