% flevbl.ElecLoc - which areas the electrodes were in?
%{
flevbl.ElecLoc (manual) # my newest table
...
classdef ElecLoc < dj.Relvar
    ...
    methods(Static)
        function tuples = makeTuples(sessKey,elec_num_and_loc)
