%{
flevbl.RelContLocCenX (computed) # my newest table
-> flevbl.TrialGroup
-> vstim.PixPerDeg
...
classdef RelContLocCenX < dj.Relvar & dj.AutoPopulate
    ...
    properties(Constant)
        table = dj.Table('flevbl.RelContLocCenX')
        popRel = flevbl.TrialGroup & flevbl.StimConstants('flash_init=1 and flash_stop =1 and flash_reverse = 1') ...
